        ...
        >
            @forelse ($getOptions() as $value => $label)
                ...
                >
                    <div
                        @class([
                        "fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-2"
                        ])>
                        <label
                            ...
                            <x-filament::input.checkbox
                                ...
                                \Filament\Support\prepare_inherited_attributes($getExtraInputAttributeBag())
                                    ->merge([
                                        'disabled' => $isDisabled || $isOptionDisabled($value, $label) || ($hasDescription($value) && $getDescription($value) === 'Penuh') ,
                                        'value' => $value,
                            ...
                            >
                                ...
                                @if ($hasDescription($value))
                                    <p
                                        ...
                                        match ($getDescription($value) === 'Penuh') {
                                            true => 'text-danger dark:text-danger-400',
